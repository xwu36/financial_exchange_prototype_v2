...
TEST(AtmMachine, CanWithdrawWithMatchers2) {
  ...
  EXPECT_CALL(mock_bankserver, Withdraw(_, Lt(10000))).Times(1);
...
TEST(AtmMachine, CanWithdrawWithMultiArgumentMatchers) {
  ...
  EXPECT_CALL(mock_bankserver, Withdraw(_, _)).With(Gt()).Times(1);
...
TEST(AtmMachine, CanWithdrawIgnoreArguments) {
  ...
  EXPECT_CALL(mock_bankserver, Withdraw).Times(1);
